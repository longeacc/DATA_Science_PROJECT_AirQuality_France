...
<body>
    <div class="header">
        <h1>📈 Distribution des Polluants Atmosphériques - Histogrammes</h1>
    </div>
    
    <div class="info">
        <strong>ℹ️ Information :</strong> Utilisez les contrôles ci-dessous pour visualiser la distribution des différents polluants par année.
    </div>
...
"""
    ...
    output_path = "superposed_histograms.html"
